...
player_1 = LeftPlayer('rocet.png', 40, 80, 40, 210, 10)
player_2 = RightPlayer('rocet.png', 40, 80, 620, 210, 10)
...
win_1 = Score('left player win !', 50, 0, 0, 700, 500)
win_2 = Score('Right player win !', 50, 0, 0, 700, 500)
